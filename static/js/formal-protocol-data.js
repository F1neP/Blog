  ...
  const pages = {
    ...
    'bgw-protocol.html': {
      ...
      specs: [{
        ...
        rows: [
          r('输入分享', '每个输入方 [[P_i]]', '每个 [[P_j]]', '私发 [[[x_i]_j=f_i(α_j)]]，其中 [[f_i(0)=x_i]]、[[deg(f_i)≤t-1]]。', '[[\\mathbb F]]、[[α_j]]、输入归属', '[[x_i]]、[[f_i]]、[[[x_i]_j]]', '私密认证信道；接收方仅保存自己的份额。'),
          ...
          r('乘法-降次', '每个 [[P_j]] 本地', '[[P_j]] 本地', '计算 [[[ab]_j=Σ_i λ_i q_i(α_j)]]。', '[[λ_i]]', '收到的子份额、[[[ab]_j]]', '常数项为 [[Σ_i λ_i h_i=ab]]，次数回到 [[t-1]]。'),
